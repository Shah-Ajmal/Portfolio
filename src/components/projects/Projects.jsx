    ...
    >
      ...
      {selectedProject && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black bg-opacity-90 p-4">
          <div className="bg-gray-900 rounded-xl shadow-2xl w-[90%] max-w-3xl relative flex flex-col overflow-auto max-h-[90vh]">
            {/* Close Button */}
            <button
            ...
            <div className="p-6 flex flex-col flex-grow">
              ...
              <div className="flex gap-4 mt-auto">
                <a
                  ...
                  className="w-1/2 bg-gray-800 text-white hover:bg-purple-800 px-4 py-2 rounded-xl text-center font-semibold"
                >
                  View Code
                </a>
                <a
